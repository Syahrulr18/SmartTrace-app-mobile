...
const DistributorTrackingScreen = () => {
    ...
    const handleOpenDetail = (shipment: TrackingData) => {
				...
				>
					...
					<View className="px-5 pt-4">
						<View className="flex-row items-center" style={{ gap: 12 }}>
							<View className="flex-1 flex-row items-center bg-white rounded-full px-3 py-0.4 border border-[#E4E7EC]" style={{ gap: 8 }}>
							...
							<TouchableOpacity
								...
								className="w-10 h-10 bg-[#0E1B2A] rounded-full items-center justify-center shadow-sm"
							>
								...
								{searchFiltered.map((tracking) => {
									...
									return (
										<TouchableOpacity
                                            ...
                                            onPress={() => handleOpenDetail(tracking)}
										>
											{/* Header with Status */}
											...
											{/* Action Button */}
											<TouchableOpacity 
                                                className="mt-3 bg-[#EFF6FF] rounded-lg py-2"
                                                onPress={() => handleOpenDetail(tracking)}
                                            >
												<Text
