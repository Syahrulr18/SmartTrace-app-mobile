	...
	return (
		<SafeAreaView className="flex-1" style={{ backgroundColor: "transparent" }}>
			...
			>
				...
				<View className="px-5 pt-4 pb-2">
					<Text
						className="text-[14px] text-[#0E1B2A] mb-3"
						style={{ fontFamily: "Montserrat-Bold" }}
					>
				...
				<View className="px-5 pt-4">
					...
					<View className="gap-4">
						{realtimeShipments.map((shipment) => (
							<View key={shipment.id} className="bg-white rounded-2xl p-4 border border-[#E2E8F0]">
									...
									>
										{shipment.status === "Hijau" ? (
											<View className="flex-row items-center gap-1">
												...
												<Text className={`text-[10px] text-[#10b981]`} style={{ fontFamily: "Montserrat-SemiBold" }}>Hijau</Text>
											</View>
										) : shipment.status === "Kuning" ? (
											<View className="flex-row items-center gap-1">
												<AlertWarningIcon size={12} color="#f59e0b" />
												<Text className={`text-[10px] text-[#f59e0b]`} style={{ fontFamily: "Montserrat-SemiBold" }}>Kuning</Text>
											</View>
										) : (
											<View className="flex-row items-center gap-1">
												<CloseIcon size={12} color="#EF4444" />
												<Text className={`text-[10px] text-[#EF4444]`} style={{ fontFamily: "Montserrat-SemiBold" }}>Merah</Text>
											</View>
										)}
									</Text>
									</View>
							...
							>
								<View className="flex-row items-start justify-between">
									<View>
										...
										<View
											className="mt-2 px-2 py-1 rounded-lg w-fit flex-row items-center gap-1"
											style={{
												backgroundColor:
													audit.status === "Sukses"
														? "#F0FDF4"
